...
public class FileBoardDAO {
	...
	public FileBoardBean fgetBoard(int num) {
		Connection con = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		...
		try {
			...
			if(rs.next()) {
				...
				bb.setFile(rs.getString("file")); // 파일 추가
			}
		} catch (Exception e) {
			e.printStackTrace();
		} finally {
	...
	public FileBoardBean fnumCheck(int num, String pass) {
		Connection con = null;
		PreparedStatement pstmt = null;
		ResultSet rs  = null;
		FileBoardBean bb = null;
	...
	public void fupdateBoard(FileBoardBean bb) {
		Connection con = null;
		PreparedStatement pstmt = null;
		try {
			con = getConnection();
	...
	public List<FileBoardBean> fgetBoardList(int startRow, int pageSize) {
