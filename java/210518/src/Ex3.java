...
class Employee {
	...
	public void salaryCalculationAll(Employee emp) { //업캐스팅
		
		int salaryResult = 0;
		
		if(emp instanceof Manager) {
		
			System.out.println("Employee -> Manager 다운캐스팅");
			...
			System.out.println("Employee -> Engineer 다운캐스팅");
...
class Manager extends Employee {
	...
	@Override
	public void salaryCalculation() {
		System.out.println("연봉 : " + (salary + manageEmployeeCount * 10));
	}
...
class Engineer extends Employee {
	...
	@Override
	public void salaryCalculation() {
		System.out.println("연봉 : " + (salary + numOfCertificate * 20));
	}
