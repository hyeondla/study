...
//		System.out.println("주민번호 : " + jumin);
	...
	public void select() {
		...
		tableModel.setRowCount(0); // 행 0개로 설정 => 기존 데이터 제거
...
//		System.out.println(strIdx);
	...
	protected void showSelectedMemberInfo() {
		
//		System.out.println(table.getSelectedRow());
//		System.out.println(table.getSelectedColumn());
//		int idx = table.getValueAt(table.getSelectedRow(), 0);
//		System.out.println(table.getValueAt(table.getSelectedRow(), 0));
		...
		String[] email = table.getValueAt(table.getSelectedRow(), 3).toString().split("@");
		tfEmail1.setText(email[0]);
		tfEmail2.setText(email[1]);
		
		String[] jumin = table.getValueAt(table.getSelectedRow(), 4).toString().split("-");
		tfJumin1.setText(jumin[0]);
		tfJumin2.setText(jumin[1]);
